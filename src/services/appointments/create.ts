  ...
  try {
    ...
    const { data, error } = await supabase.rpc('create_appointment', {
      appointment_data: {
        ...
        contactId: appointmentData.contact_id, // Utiliser contactId pour correspondre à la structure DB
        freelancerid: appointmentData.freelancer_id, // Utiliser freelancerid pour correspondre à la structure DB
